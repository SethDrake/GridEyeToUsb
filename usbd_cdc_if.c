...
static int8_t GridEyeToUsb_Init     (void);
static int8_t GridEyeToUsb_DeInit   (void);
static int8_t GridEyeToUsb_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t GridEyeToUsb_Receive  (uint8_t* pbuf, uint32_t *Len);
static int8_t GridEyeToUsb_TransmitCompleted(uint8_t *Buf, uint32_t *Len, uint8_t epnum);

USBD_CDC_ItfTypeDef USBD_CDC_GridEyeToUsb_fops = 
{
  GridEyeToUsb_Init,
  GridEyeToUsb_DeInit,
  GridEyeToUsb_Control,
  GridEyeToUsb_Receive,
  GridEyeToUsb_TransmitCompleted
};
...
/**
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t GridEyeToUsb_Receive(uint8_t* Buf, uint32_t *Len)
{
